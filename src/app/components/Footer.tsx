...
export default function Footer() {
    return (
      <footer className="p-6 text-center px-80 mt-16">
        <div className="flex flex-row justify-between ">
          ...
          <p className="mt-16 mb-16 text-xl font-bold border-t-[1px] border-[#4e4c4c] pt-8">© 2024 Polluxchain. All rights reserved.</p>
      </footer>
    );
  }
