    ...
    <div className=" min-h-screen px-2 md:px-4 lg:px-6 xl:px-44 mt-32  ">
      ...
      <div className="text-center mt-16 md:mt-24">
        ...
        <div className="flex flex-col md:flex-row justify-center space-x-0 md:space-x-16 lg:space-x-24 w-full -mt-28">
          ...
          <div className="flex flex-col items-center w-full md:w-[40%] lg:w-[30%] xl:w-[25%] border-[1px] border-[#575555] mt-8 md:mt-0 p-4 rounded-4xl bg-[#0e0d0d] rounded-2xl pt-12 pb-12 transform transition-transform duration-200 hover:scale-105">
            <p className="  bg-white bg-opacity-10 rounded-full w-40 h-40 text-center "></p>
        ...
        <div className=" mt-20 mx-auto">
          <p className="text-center text-3xl md:text-4xl font-semibold mb-12">
            Our Expert Team
          </p>
